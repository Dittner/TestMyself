...
public class DeletePhraseFilterByPhraseTransactionPhase extends PhaseOperation {

	[Embed(source="/dittner/testmyself/command/backend/phrase/sql/DeletePhraseFilterByPhrase.sql", mimeType="application/octet-stream")]
	...
	public function DeletePhraseFilterByPhraseTransactionPhase(sqlRunner:SQLRunner, phraseID:int) {
		super();
