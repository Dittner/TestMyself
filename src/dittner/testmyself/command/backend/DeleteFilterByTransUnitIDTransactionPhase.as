...
public class DeleteFilterByTransUnitIDTransactionPhase extends PhaseOperation {

	public function DeleteFilterByTransUnitIDTransactionPhase(sqlRunner:SQLRunner, transUnitID:int, sqlFactory:SQLFactory) {
		super();
	...
	override public function execute():void {
		if (transUnitID) {
			...
			statements.push(new QueuedStatement(sqlFactory.deleteFilterByTransUnitID, {deletingTransUnitID: transUnitID}));
