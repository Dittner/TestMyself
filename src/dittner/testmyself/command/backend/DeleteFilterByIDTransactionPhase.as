...
public class DeleteFilterByIDTransactionPhase extends PhaseOperation {

	public function DeleteFilterByIDTransactionPhase(sqlRunner:SQLRunner, themeID:int, sqlFactory:SQLFactory) {
		super();
