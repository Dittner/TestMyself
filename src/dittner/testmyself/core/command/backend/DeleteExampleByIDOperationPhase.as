...
public class DeleteExampleByIDOperationPhase extends PhaseOperation {

	public function DeleteExampleByIDOperationPhase(sqlRunner:SQLRunner, exampleID:int, sqlFactory:SQLFactory) {
		super();
	...
	override public function execute():void {
		if (exampleID) {
			...
			statements.push(new QueuedStatement(sqlFactory.deleteExampleByID, {deletingID: exampleID}));
