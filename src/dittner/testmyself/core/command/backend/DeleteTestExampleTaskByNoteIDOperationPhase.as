...
public class DeleteTestExampleTaskByNoteIDOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function DeleteTestExampleTaskByNoteIDOperationPhase(conn:SQLConnection, noteID:int, sqlFactory:SQLFactory) {
		super();
		this.conn = conn;
		this.noteID = noteID;
	...
	public function execute():void {
		if (noteID != -1) {
			var statement:SQLStatement = SQLUtils.createSQLStatement(sqlFactory.deleteTestExampleTaskByNoteID, {deletingNoteID: noteID});
