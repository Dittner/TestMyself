...
public class ExampleCountOperationPhase extends PhaseOperation {

	public function ExampleCountOperationPhase(sqlRunner:SQLRunner, info:NotesInfo, sqlFactory:SQLFactory) {
	...
	override public function execute():void {
		sqlRunner.execute(sqlFactory.selectCountExample, null, executeComplete);
	}
