...
public class DeleteThemeOperationPhase extends PhaseOperation {

	public function DeleteThemeOperationPhase(sqlRunner:SQLRunner, themeID:int, sqlFactory:SQLFactory) {
		super();
