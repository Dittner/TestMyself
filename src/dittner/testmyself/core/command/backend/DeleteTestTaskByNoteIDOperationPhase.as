...
public class DeleteTestTaskByNoteIDOperationPhase extends AsyncOperation implements ICommand {

	public function DeleteTestTaskByNoteIDOperationPhase(conn:SQLConnection, noteID:int, sqlFactory:SQLFactory) {
		super();
		this.conn = conn;
		this.noteID = noteID;
	...
	public function execute():void {
		if (noteID != -1) {
			var statement:SQLStatement = SQLUtils.createSQLStatement(sqlFactory.deleteTestTaskByNoteID, {deletingNoteID: noteID});
