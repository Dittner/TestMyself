...
public class RemoveExamplesCmd extends StorageOperation implements IAsyncCommand {

	public function RemoveExamplesCmd(storage:Storage) {
		super();
	...
	private function loadAllExamples():void {
		var sql:String = "SELECT * FROM note where isExample = 0";
