...
public class CountAudioCommentOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function CountAudioCommentOperationPhase(conn:SQLConnection, info:VocabularyInfo) {
		this.conn = conn;
		this.info = info;
	}
