...
public class InsertTestTaskOperationSubPhase extends AsyncOperation implements IAsyncCommand {
	public function InsertTestTaskOperationSubPhase(conn:SQLConnection, note:Note, test:Test) {
		this.note = note;
		this.conn = conn;
		this.test = test;
	}
