...
public class CountNotesBySearchOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function CountNotesBySearchOperationPhase(storage:SQLStorage, page:SearchPageInfo) {
