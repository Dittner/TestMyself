...
public class CountExampleOperation extends AsyncOperation implements IAsyncCommand {

	public function CountExampleOperation(conn:SQLConnection, info:VocabularyInfo) {
		this.conn = conn;
		this.info = info;
	}
