...
public class InsertFilterOperationSubPhase extends AsyncOperation implements IAsyncCommand {
	public function InsertFilterOperationSubPhase(noteID:int, theme:Theme, conn:SQLConnection, sql:String) {
		this.noteID = noteID;
		this.theme = theme;
		this.conn = conn;
		this.sql = sql;
