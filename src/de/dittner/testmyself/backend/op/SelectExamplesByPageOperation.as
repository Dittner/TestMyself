...
public class SelectExamplesByPageOperation extends AsyncOperation implements IAsyncCommand {

	public function SelectExamplesByPageOperation(storage:SQLStorage, page:IPageInfo) {
		super();
