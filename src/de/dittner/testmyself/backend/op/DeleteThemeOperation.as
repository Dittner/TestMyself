...
public class DeleteThemeOperation extends AsyncOperation implements IAsyncCommand {

	public function DeleteThemeOperation(conn:SQLConnection, themeID:int) {
		super();
		this.conn = conn;
	...
	public function execute():void {
		if (themeID == -1) {
			...
			var statement:SQLStatement = SQLUtils.createSQLStatement(SQLLib.DELETE_THEME_SQL, {deletingThemeID: themeID});
