...
public class CountExampleOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function CountExampleOperationPhase(conn:SQLConnection, info:VocabularyInfo) {
		this.conn = conn;
		this.info = info;
	}
