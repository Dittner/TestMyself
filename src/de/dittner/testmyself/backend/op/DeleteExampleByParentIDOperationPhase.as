...
public class DeleteExampleByParentIDOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function DeleteExampleByParentIDOperationPhase(conn:SQLConnection, parentID:int) {
		super();
		this.conn = conn;
