...
public class CountNoteOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function CountNoteOperationPhase(conn:SQLConnection, info:VocabularyInfo) {
		this.conn = conn;
		this.info = info;
	}
