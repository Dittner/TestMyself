...
public class NoteWithAudioCountOperationPhase extends AsyncOperation implements IAsyncCommand {

	public function NoteWithAudioCountOperationPhase(conn:SQLConnection, info:NotesInfo, sqlFactory:SQLLib) {
		this.conn = conn;
		this.info = info;
