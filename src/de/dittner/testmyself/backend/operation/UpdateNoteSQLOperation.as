...
public class UpdateNoteSQLOperation extends AsyncOperation implements IAsyncCommand {
	...
	public function UpdateNoteSQLOperation(service:SQLStorage, suite:NoteSuite, testModel:TestModel) {
	...
	public function execute():void {
		...
		composite.addOperation(UpdateNoteOperationPhase, service.sqlConnection, suite.note, service.sqlFactory);
		...
		composite.addOperation(DeleteExampleByParentIDOperationPhase, service.sqlConnection, suite.note.id, service.sqlFactory);
