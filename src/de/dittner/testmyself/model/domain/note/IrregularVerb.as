...
public class IrregularVerb extends Note {
	...
	public static function toSearchText(title:String, present:String, past:String, perfect:String, description:String):String {
		return correctSearchText(SEARCH_DELIMITER + title + SEARCH_DELIMITER + present + SEARCH_DELIMITER + past + SEARCH_DELIMITER + perfect + SEARCH_DELIMITER + description + SEARCH_DELIMITER).toLocaleLowerCase();
	}
