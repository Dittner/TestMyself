...
public class VerbSQLFactory extends SQLFactory {
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/CreateVerbTbl.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/InsertVerb.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/UpdateVerb.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/SelectVerbKeys.sql", mimeType="application/octet-stream")]
