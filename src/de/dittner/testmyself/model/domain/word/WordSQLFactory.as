...
public class WordSQLFactory extends SQLFactory {
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/CreateWordTbl.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/InsertWord.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/UpdateWord.sql", mimeType="application/octet-stream")]
	...
	[Embed(source="/de/dittner/testmyself/backend/sql/SelectWordKeys.sql", mimeType="application/octet-stream")]
