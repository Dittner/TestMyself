...
public class ExamplesFormRenderer extends NoteRenderer {
	private static const TITLE_FORMAT:TextFormat = new TextFormat(FontName.BASIC_MX, Values.PT16, AppColors.BLACK, true);
	private static const DESCRIPTION_FORMAT:TextFormat = new TextFormat(FontName.BASIC_MX, Values.PT16, AppColors.TEXT_DARK_GRAY);
